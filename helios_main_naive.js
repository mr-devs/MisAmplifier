...
const edges_url = '../data/edges_all_naive.json'
const nodes_url = '../data/nodes_all_naive.json'
...
//   nodes[key]["size"] = Math.pow(Math.log10(sizeDictionary[key])+1, 2);
// }
...
console.log("Entire Scale")
console.log(colorScale)

// console.log("Indiv. color")
...
.nodeColor(node=>{ 
  // console.log(colorScale)
  let color = d3rgb(colorScale(node.affected));
